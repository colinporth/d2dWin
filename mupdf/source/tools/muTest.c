...
static int showfeatures = 1;
static int showtime = 1;
static int showmemory = 1;
...
int main(int argc, char **argv) {
	...
	if (band_height) {
		if (output_format != OUT_PAM && output_format != OUT_PGM && output_format != OUT_PPM &&
				output_format != OUT_PNM && output_format != OUT_PNG && output_format != OUT_PBM &&
				output_format != OUT_PKM && output_format != OUT_PCL && output_format != OUT_PCLM &&
				output_format != OUT_PS && output_format != OUT_PSD && output_format != OUT_TGA) {
	...
	else if (output_format == OUT_GPROOF || output_format == OUT_SVG) {
