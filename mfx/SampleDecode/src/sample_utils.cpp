...
CH264FrameReader::CH264FrameReader()
  : CSmplBitstreamReader() , m_processedBS(0) , m_isEndOfStream(false) , m_frame(0),
    m_plainBuffer(0) , m_plainBufferSize(0) {}
//}}}
//{{{
CH264FrameReader::~CH264FrameReader() {}
//}}}
...
//}}}
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxU8& value)
{
...
//}}}
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxU16& value)
{
    msdk_char* stopCharacter;
...
//}}}
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxU32& value)
{
    msdk_char* stopCharacter;
...
//}}}
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxF32& value)
{
    msdk_char* stopCharacter;
...
//}}}
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxF64& value)
{
    msdk_char* stopCharacter;
...
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxI16& value)
{
    msdk_char* stopCharacter;
...
//}}}
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxI32& value)
{
    msdk_char* stopCharacter;
...
//{{{
template<> mfxStatus msdk_opt_read(const msdk_char* string, mfxPriority& value)
{
    mfxU32 priority = 0;
