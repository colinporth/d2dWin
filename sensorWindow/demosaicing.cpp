...
{
//{{{
template<typename T> class SIMDBayerStubInterpolator_
{
public:
...
//{{{
template<typename T, class SIMDInterpolator> class Bayer2Gray_Invoker :
...
//}}}
//{{{
template<typename T, typename SIMDInterpolator> static void Bayer2Gray_( const Mat& srcmat, Mat& dstmat, int code )
{
    const int R2Y = 4899;
    const int B2Y = 1868;
...
//{{{
template <typename T, typename SIMDInterpolator> class Bayer2RGB_Invoker :
    public ParallelLoopBody
{
public:
    //{{{
...
//}}}
//{{{
template<typename T, class SIMDInterpolator> static void Bayer2RGB_( const Mat& srcmat, Mat& dstmat, int code )
{
    int dst_step = (int)(dstmat.step/sizeof(T));
    Size size = srcmat.size();
...
template <typename T, typename SIMDInterpolator> class Bayer2RGB_EdgeAware_T_Invoker :
...
//}}}
//{{{
template <typename T, typename SIMDInterpolator> static void Bayer2RGB_EdgeAware_T(const Mat& src, Mat& dst, int code)
{
    Size size = src.size();
