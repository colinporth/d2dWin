...
public:
  ...
  void onDraw (ID2D1DeviceContext* dc) {
    ...
    dc->DrawLine (getCentre(), getCentre() + cPoint(hourRadius * sin (hourAngle), hourRadius * cos (hourAngle)),
    ...
    dc->DrawLine (getCentre(), getCentre() + cPoint (minRadius * sin (minAngle), minRadius * cos (minAngle)),
                  mWindow->getWhiteBrush(), 2.f);
    ...
    dc->DrawLine (getCentre(), getCentre() + cPoint (secRadius * sin (secAngle), secRadius * cos (secAngle)),
    ...
    if (mShowSubSec) {
      ...
      dc->DrawLine (getCentre(), getCentre() + cPoint (subSecRadius * sin (subSecAngle), secRadius * cos (subSecAngle)),
