...
namespace htmlcxx {
  ...
  namespace HTML {
    ...
    /** Trim the argument string at both end and convert sibling blanks * into a single space */
    ...
    /** Get the value of an attribute inside the text of a tag
      * @return empty string if the attribute is not found, or the value of the attribute */
